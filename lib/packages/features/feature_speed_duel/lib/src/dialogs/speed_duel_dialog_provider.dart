...
import 'declare_phase_dialog/models/declare_phase_dialog_parameters.dart';
import 'declare_phase_dialog/widgets/declare_phase_dialog_provider.dart';
...
class SpeedDuelDialogProvider {
  ...
  Widget createDeclarePhaseDialog(DeclarePhaseDialogParameters parameters) {
    return DeclarePhaseDialogProvider(parameters: parameters);
  }
}
