...
import 'package:shared_preferences/shared_preferences.dart' as _i80;
import 'package:socket_io_client/socket_io_client.dart' as _i85;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i53.FileManager>(() =>
      _i53.FileManagerImpl(get<_i40.Dio>(instanceName: 'FileManagerDio')));
  ...
  gh.lazySingleton<_i75.RemoteConfigProvider>(
      () => _i76.WebRemoteConfigProvider(),
      registerFor: {_web});
  gh.factory<_i77.SelectDeckDialogViewModel>(() =>
      _i77.SelectDeckDialogViewModel(
          get<_i5.AppRouter>(),
          get<_i10.DataManager>(),
          get<_i5.DialogService>(),
          get<_i33.Logger>()));
  gh.lazySingleton<_i78.SettingsDataManager>(
      () => _i78.SettingsDataManagerImpl(get<_i15.SettingsStorageProvider>()));
  gh.lazySingleton<_i79.SettingsStorageProvider>(() =>
      _i79.SettingsStorageProviderImpl(get<_i50.SharedPreferencesProvider>()));
  await gh.lazySingletonAsync<_i80.SharedPreferences>(
      () => sharedPreferencesModule.provideSharedPreferences(),
      preResolve: true);
  gh.lazySingleton<_i81.SharedPreferencesProvider>(
      () => _i81.SharedPreferencesProviderImpl(get<_i80.SharedPreferences>()));
  gh.lazySingleton<_i82.SmartDuelServer>(() => _i82.SmartDuelServerImpl(
      get<_i83.WebSocketFactory>(), get<_i33.Logger>()));
  gh.lazySingleton<_i84.SnackBarService>(() => _i84.SnackBarServiceImpl());
  gh.factory<_i85.Socket>(
      () => socketIoModule.provideSocket(get<_i10.DataManager>()));
  gh.lazySingleton<_i86.SpeedDuelDialogProvider>(
      () => _i86.SpeedDuelDialogProvider());
  gh.lazySingleton<_i87.SpeedDuelEventAnimationHandler>(
      () => _i87.SpeedDuelEventAnimationHandler(
          get<_i4.DelayProvider>(), get<_i33.Logger>()),
      dispose: (i) => i.dispose());
  gh.lazySingleton<_i88.SpeedDuelEventAudioHandler>(
      () => _i88.SpeedDuelEventAudioHandler(get<_i13.AudioPlayerProvider>()));
  ...
  gh.factoryParam<_i90.SpeedDuelViewModel, _i47.DuelRoom?, dynamic>(
      (_duelRoom, _) => _i90.SpeedDuelViewModel(
          ...
          get<_i87.SpeedDuelEventAnimationHandler>(),
          get<_i88.SpeedDuelEventAudioHandler>(),
          get<_i10.DataManager>(),
  ...
  gh.factory<_i99.WebSocketProvider>(
      () => _i99.WebSocketProviderImpl(get<_i85.Socket>(), get<_i33.Logger>()));
  gh.lazySingleton<_i100.YgoProDeckRestClient>(() =>
      _i100.YgoProDeckRestClient(get<_i40.Dio>(instanceName: 'YgoProDeckDio')));
  gh.factoryParam<_i101.YugiohCardDetailViewModel, _i10.CardCopy?, String?>(
      (_cardCopy, _tag) =>
          _i101.YugiohCardDetailViewModel(_cardCopy, _tag, get<_i33.Logger>()));
  ...
  gh.lazySingleton<_i110.YgoProDeckApiProvider>(() =>
      _i110.YgoProDeckApiProviderImpl(
          get<_i100.YgoProDeckRestClient>(), get<_i33.Logger>()));
  return get;
}

class _$FlutterModule extends _i111.FlutterModule {}

class _$AudioPlayerModule extends _i112.AudioPlayerModule {}

class _$StorageModule extends _i113.StorageModule {}

class _$LocalizationModule extends _i114.LocalizationModule {}

class _$ConnectivityModule extends _i115.ConnectivityModule {}

class _$YgoProDeckModule extends _i116.YgoProDeckModule {}

class _$FileManagerModule extends _i117.FileManagerModule {}
