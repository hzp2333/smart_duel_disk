...
import 'package:dart_twitter_api/twitter_api.dart' as _i99;
...
import 'package:firebase_remote_config/firebase_remote_config.dart' as _i78;
import 'package:flutter/services.dart' as _i11;
import 'package:get_it/get_it.dart' as _i1;
import 'package:hive/hive.dart' as _i20;
import 'package:injectable/injectable.dart' as _i2;
import 'package:shared_preferences/shared_preferences.dart' as _i85;
import 'package:socket_io_client/socket_io_client.dart' as _i90;
...
import '../../packages/core/core_storage/lib/src/yugioh_cards/yugioh_cards_storage_provider.dart'
    as _i109;
import '../../packages/core/core_ygoprodeck/lib/core_ygoprodeck.dart' as _i108;
...
import '../../packages/wrappers/audio_player/src/di/audio_player_module.dart'
    as _i119;
import '../../packages/wrappers/wrapper_auth/src/auth_provider.dart' as _i110;
import '../../packages/wrappers/wrapper_auth/src/di/auth_module.dart' as _i126;
...
import '../../packages/wrappers/wrapper_web_socket/lib/wrapper_web_socket.dart'
    as _i88;
import 'modules/flutter_module.dart' as _i118;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i78.RemoteConfig>(
      () => remoteConfigModule.provideRemoteConfig());
  gh.lazySingleton<_i79.RemoteConfigProvider>(
      () => _i80.WebRemoteConfigProvider(),
      registerFor: {_web});
  gh.lazySingleton<_i79.RemoteConfigProvider>(
      () => _i81.FirebaseRemoteConfigProvider(get<_i78.RemoteConfig>()),
      registerFor: {_mobile});
  gh.factory<_i82.SelectDeckDialogViewModel>(() =>
      _i82.SelectDeckDialogViewModel(
          get<_i5.AppRouter>(),
          get<_i10.DataManager>(),
          get<_i5.DialogService>(),
          get<_i18.Logger>()));
  gh.lazySingleton<_i83.SettingsDataManager>(
      () => _i83.SettingsDataManagerImpl(get<_i21.SettingsStorageProvider>()));
  gh.lazySingleton<_i84.SettingsStorageProvider>(() =>
      _i84.SettingsStorageProviderImpl(get<_i56.SharedPreferencesProvider>()));
  await gh.lazySingletonAsync<_i85.SharedPreferences>(
      () => sharedPreferencesModule.provideSharedPreferences(),
      preResolve: true);
  gh.lazySingleton<_i86.SharedPreferencesProvider>(
      () => _i86.SharedPreferencesProviderImpl(get<_i85.SharedPreferences>()));
  gh.lazySingleton<_i87.SmartDuelServer>(() => _i87.SmartDuelServerImpl(
      get<_i88.WebSocketFactory>(), get<_i18.Logger>()));
  gh.lazySingleton<_i89.SnackBarService>(() => _i89.SnackBarServiceImpl());
  gh.factory<_i90.Socket>(
      () => socketIoModule.provideSocket(get<_i10.DataManager>()));
  gh.lazySingleton<_i91.SpeedDuelDialogProvider>(
      () => _i91.SpeedDuelDialogProvider());
  gh.lazySingleton<_i92.SpeedDuelEventAnimationHandler>(
      () => _i92.SpeedDuelEventAnimationHandler(
          get<_i4.DelayProvider>(), get<_i18.Logger>()),
      dispose: (i) => i.dispose());
  gh.lazySingleton<_i93.SpeedDuelEventAudioHandler>(
      () => _i93.SpeedDuelEventAudioHandler(get<_i13.AudioPlayerProvider>()));
  gh.lazySingleton<_i94.SpeedDuelEventEmitter>(() => _i94.SpeedDuelEventEmitter(
      get<_i53.SmartDuelServer>(), get<_i32.EnumHelper>(), get<_i18.Logger>()));
  gh.factoryParam<_i95.SpeedDuelViewModel, _i53.DuelRoom?, dynamic>(
      (_duelRoom, _) => _i95.SpeedDuelViewModel(
          _duelRoom,
          get<_i5.AppRouter>(),
          get<_i53.SmartDuelServer>(),
          ...
          get<_i94.SpeedDuelEventEmitter>(),
          get<_i92.SpeedDuelEventAnimationHandler>(),
          get<_i93.SpeedDuelEventAudioHandler>(),
          get<_i10.DataManager>(),
          get<_i68.CrashlyticsProvider>(),
          get<_i42.SnackBarService>(),
          get<_i96.DisplayConfigService>(),
          get<_i18.Logger>()));
  gh.lazySingleton<_i97.StringProvider>(() => _i97.StringProviderImpl());
  gh.lazySingleton<_i98.SystemChromeProvider>(
      () => _i98.SystemChromeProviderImpl());
  gh.lazySingleton<_i99.TwitterApi>(
      () => twitterModule.provideTwitterApi(get<_i4.AppConfig>()));
  gh.lazySingleton<_i100.TwitterProvider>(
      () => _i100.TwitterProviderImpl(get<_i99.TwitterApi>()));
  gh.lazySingleton<_i101.UrlLauncherProvider>(
      () => _i101.UrlLauncherProviderImpl());
  gh.factory<_i102.UserSettingsViewModel>(() => _i102.UserSettingsViewModel(
      get<_i5.AppRouter>(),
      get<_i15.AuthenticationService>(),
      get<_i10.DataManager>(),
      get<_i42.SnackBarService>(),
      get<_i38.StringProvider>(),
      get<_i66.Logger>()));
  gh.lazySingleton<_i103.WebSocketFactory>(() => _i103.WebSocketFactoryImpl());
  gh.factory<_i104.WebSocketProvider>(() =>
      _i104.WebSocketProviderImpl(get<_i90.Socket>(), get<_i18.Logger>()));
  gh.lazySingleton<_i105.YgoProDeckRestClient>(() =>
      _i105.YgoProDeckRestClient(get<_i45.Dio>(instanceName: 'YgoProDeckDio')));
  gh.factoryParam<_i106.YugiohCardDetailViewModel, _i10.CardCopy?, String?>(
      (_cardCopy, _tag) =>
          _i106.YugiohCardDetailViewModel(_cardCopy, _tag, get<_i18.Logger>()));
  gh.lazySingleton<_i107.YugiohCardsDataManager>(() =>
      _i107.YugiohCardsDataManagerImpl(
          get<_i108.YgoProDeckApiProvider>(),
          get<_i21.YugiohCardsStorageProvider>(),
          get<_i32.EnumHelper>(),
          get<_i18.Logger>()));
  gh.lazySingleton<_i109.YugiohCardsStorageProvider>(() =>
      _i109.YugiohCardsStorageProviderImpl(
          get<_i20.Box<_i21.DbYugiohCard>>(),
          get<_i56.SharedPreferencesProvider>(),
          get<_i79.RemoteConfigProvider>(),
          get<_i4.DateTimeProvider>(),
          get<_i18.Logger>()));
  gh.lazySingleton<_i110.AuthProvider>(
      () => _i111.FirebaseAuthProvider(get<_i60.FirebaseAuth>()));
  gh.lazySingleton<_i112.CardImageDataManager>(() =>
      _i112.CardImageDataManagerImpl(get<_i59.FileManager>(),
          get<_i47.Directory>(instanceName: 'AppDirectory')));
  gh.lazySingleton<_i113.CloudDatabaseProvider>(
      () => _i114.FirebaseCloudDatabaseProvider(get<_i62.FirebaseFirestore>()));
  gh.lazySingleton<_i28.CrashlyticsProvider>(
      () => _i115.FirebaseCrashlyticsProvider(get<_i61.FirebaseCrashlytics>()),
      registerFor: {_mobile});
  gh.lazySingleton<_i116.DisplayConfigService>(
      () => _i116.DisplayConfigServiceImpl(get<_i98.SystemChromeProvider>()));
  gh.lazySingleton<_i117.YgoProDeckApiProvider>(() =>
      _i117.YgoProDeckApiProviderImpl(
          get<_i105.YgoProDeckRestClient>(), get<_i18.Logger>()));
  return get;
}

class _$FlutterModule extends _i118.FlutterModule {}

class _$AudioPlayerModule extends _i119.AudioPlayerModule {}

class _$NavigationModule extends _i120.NavigationModule {}

class _$StorageModule extends _i121.StorageModule {}

class _$LocalizationModule extends _i122.LocalizationModule {}

class _$ConnectivityModule extends _i123.ConnectivityModule {}

class _$YgoProDeckModule extends _i124.YgoProDeckModule {}

class _$PathProviderModule extends _i125.PathProviderModule {}

class _$AuthModule extends _i126.AuthModule {}

class _$CrashlyticsModule extends _i127.CrashlyticsModule {}

class _$CloudDatabaseModule extends _i128.CloudDatabaseModule {}

class _$RemoteConfigModule extends _i129.RemoteConfigModule {}

class _$SharedPreferencesModule extends _i130.SharedPreferencesModule {}

class _$SocketIoModule extends _i131.SocketIoModule {}

class _$TwitterModule extends _i132.TwitterModule {}
