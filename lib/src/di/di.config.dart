...
import 'package:dart_twitter_api/twitter_api.dart' as _i69;
...
import 'package:socket_io_client/socket_io_client.dart' as _i66;
...
import '../../packages/core/core_storage/lib/src/yugioh_cards/yugioh_cards_storage_provider.dart'
    as _i79;
import '../../packages/core/core_ygoprodeck/lib/core_ygoprodeck.dart' as _i78;
...
import '../../packages/wrappers/wrapper_web_socket/lib/wrapper_web_socket.dart'
    as _i64;
import 'modules/flutter_module.dart' as _i84;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i43.HomeViewModel>(
      () => _i43.HomeViewModel(get<_i5.AppRouter>(), get<_i14.Logger>()));
  ...
  gh.lazySingleton<_i59.SettingsDataManager>(
      () => _i59.SettingsDataManagerImpl(get<_i32.SettingsStorageProvider>()));
  gh.lazySingleton<_i60.SettingsStorageProvider>(() =>
      _i60.SettingsStorageProviderImpl(get<_i38.SharedPreferencesProvider>()));
  await gh.lazySingletonAsync<_i61.SharedPreferences>(
      () => sharedPreferencesModule.provideSharedPreferences(),
      preResolve: true);
  gh.lazySingleton<_i62.SharedPreferencesProvider>(
      () => _i62.SharedPreferencesProviderImpl(get<_i61.SharedPreferences>()));
  gh.lazySingleton<_i63.SmartDuelServer>(() => _i63.SmartDuelServerImpl(
      get<_i64.WebSocketFactory>(), get<_i14.Logger>()));
  gh.lazySingleton<_i65.SnackBarService>(() => _i65.SnackBarServiceImpl());
  gh.factory<_i66.Socket>(
      () => socketIoModule.provideSocket(get<_i19.DataManager>()));
  gh.lazySingleton<_i67.SpeedDuelDialogProvider>(
      () => _i67.SpeedDuelDialogProvider());
  gh.factoryParam<_i68.SpeedDuelViewModel, _i36.DuelRoom, dynamic>(
      (_duelRoom, _) => _i68.SpeedDuelViewModel(
          get<_i14.Logger>(),
          _duelRoom,
          get<_i5.AppRouter>(),
          get<_i36.SmartDuelServer>(),
  ...
  gh.lazySingleton<_i69.TwitterApi>(
      () => twitterModule.provideTwitterApi(get<_i4.AppConfig>()));
  gh.lazySingleton<_i70.TwitterProvider>(
      () => _i70.TwitterProviderImpl(get<_i69.TwitterApi>()));
  gh.lazySingleton<_i71.UrlLauncherProvider>(
      () => _i71.UrlLauncherProviderImpl());
  gh.factory<_i72.UserSettingsViewModel>(() => _i72.UserSettingsViewModel(
      get<_i19.DataManager>(),
      get<_i26.SnackBarService>(),
      get<_i45.Logger>()));
  gh.lazySingleton<_i73.WebSocketFactory>(() => _i73.WebSocketFactoryImpl());
  gh.factory<_i74.WebSocketProvider>(
      () => _i74.WebSocketProviderImpl(get<_i66.Socket>(), get<_i14.Logger>()));
  gh.lazySingleton<_i75.YgoProDeckRestClient>(
      () => _i75.YgoProDeckRestClient(get<_i28.Dio>()));
  gh.factoryParam<_i76.YugiohCardDetailViewModel, _i19.YugiohCard, int>(
      (_yugiohCard, _index) => _i76.YugiohCardDetailViewModel(
          get<_i14.Logger>(), _yugiohCard, _index));
  gh.lazySingleton<_i77.YugiohCardsDataManager>(() =>
      _i77.YugiohCardsDataManagerImpl(get<_i78.YgoProDeckApiProvider>(),
          get<_i32.YugiohCardsStorageProvider>()));
  gh.lazySingleton<_i79.YugiohCardsStorageProvider>(
      () => _i79.YugiohCardsStorageProviderImpl());
  gh.lazySingleton<_i80.CloudDatabaseProvider>(() =>
      _i81.FirebaseCloudDatabaseProvider(
          get<_i42.FirebaseFirestore>(), get<_i17.EnumHelper>()));
  gh.lazySingleton<_i11.CrashlyticsProvider>(
      () => _i82.FirebaseCrashlyticsProvider(get<_i41.FirebaseCrashlytics>()),
      registerFor: {_mobile});
  gh.lazySingleton<_i83.YgoProDeckApiProvider>(
      () => _i83.YgoProDeckApiProviderImpl(get<_i75.YgoProDeckRestClient>()));
  return get;
}

class _$FlutterModule extends _i84.FlutterModule {}

class _$YgoProDeckModule extends _i85.YgoProDeckModule {}

class _$CrashlyticsModule extends _i86.CrashlyticsModule {}

class _$CloudDatabaseModule extends _i87.CloudDatabaseModule {}

class _$SharedPreferencesModule extends _i88.SharedPreferencesModule {}

class _$SocketIoModule extends _i89.SocketIoModule {}

class _$TwitterModule extends _i90.TwitterModule {}
