...
import 'package:dart_twitter_api/twitter_api.dart' as _i83;
import 'package:dio/dio.dart' as _i36;
import 'package:firebase_crashlytics/firebase_crashlytics.dart' as _i49;
...
import 'package:socket_io_client/socket_io_client.dart' as _i76;
...
import '../../packages/core/core_display_config/lib/src/display_config_service.dart'
    as _i97;
import '../../packages/core/core_general/lib/core_general.dart' as _i62;
...
import '../../packages/core/core_logger/lib/src/logger.dart' as _i54;
import '../../packages/core/core_logger/lib/src/logger_impl.dart' as _i55;
import '../../packages/core/core_messaging/lib/core_messaging.dart' as _i33;
...
import '../../packages/core/core_storage/lib/src/yugioh_cards/yugioh_cards_storage_provider.dart'
    as _i93;
import '../../packages/core/core_ygoprodeck/lib/core_ygoprodeck.dart' as _i92;
...
import '../../packages/wrappers/wrapper_web_socket/lib/wrapper_web_socket.dart'
    as _i74;
import 'modules/flutter_module.dart' as _i99;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i28.DeckBuilderViewModel, _i25.PreBuiltDeck?, dynamic>(
      (_preBuiltDeck, _) => _i28.DeckBuilderViewModel(
          _preBuiltDeck,
          get<_i5.AppRouter>(),
          get<_i25.DataManager>(),
          get<_i29.StringProvider>(),
          get<_i14.Logger>()));
  gh.lazySingleton<_i30.DeckDataManager>(
      () => _i30.DeckDataManagerImpl(get<_i31.CloudDatabaseProvider>()));
  gh.factory<_i32.DeckViewModel>(() => _i32.DeckViewModel(
      get<_i5.AppRouter>(),
      get<_i25.DataManager>(),
      get<_i33.SnackBarService>(),
      get<_i29.StringProvider>(),
      get<_i14.Logger>()));
  gh.lazySingleton<_i34.DelayProvider>(() => _i34.DelayProviderImpl());
  gh.lazySingleton<_i35.DialogService>(
      () => _i35.DialogServiceImpl(get<_i5.AutoRouteRouter>()));
  gh.lazySingleton<_i36.Dio>(() => ygoProDeckModule.provideYgoProDeckDio(
      get<_i4.AppConfig>(), get<_i4.DioPluginProvider>(), get<_i14.Logger>()));
  gh.lazySingleton<_i37.DioPluginProvider>(() => _i37.DioPluginProviderImpl());
  gh.lazySingleton<_i38.DoesCardFitInZoneUseCase>(
      () => _i38.DoesCardFitInZoneUseCase());
  gh.lazySingleton<_i39.DuelDataManager>(() => _i39.DuelDataManagerImpl(
      get<_i4.AppConfig>(), get<_i11.DuelStorageProvider>()));
  gh.lazySingleton<_i40.DuelDialogProvider>(() => _i40.DuelDialogProvider());
  gh.lazySingleton<_i41.DuelFormValidators>(
      () => _i41.DuelFormValidators(get<_i29.StringProvider>()));
  gh.factoryParam<_i42.DuelRoomViewModel, _i25.PreBuiltDeck?, dynamic>(
      (_preBuiltDeck, _) => _i42.DuelRoomViewModel(
          _preBuiltDeck,
          get<_i5.AppRouter>(),
          get<_i43.SmartDuelServer>(),
          get<_i25.DataManager>(),
          get<_i33.SnackBarService>(),
          get<_i44.ClipboardProvider>(),
          get<_i14.Logger>()));
  gh.lazySingleton<_i45.DuelStorageProvider>(() =>
      _i45.DuelStorageProviderImpl(get<_i46.SharedPreferencesProvider>()));
  gh.factory<_i47.DuelViewModel>(() => _i47.DuelViewModel(
      get<_i41.DuelFormValidators>(),
      get<_i5.AppRouter>(),
      get<_i25.DataManager>(),
      get<_i14.Logger>()));
  gh.lazySingleton<_i48.EnumHelper>(() => _i48.EnumHelperImpl());
  gh.lazySingleton<_i49.FirebaseCrashlytics>(
  ...
  gh.lazySingleton<_i51.GetHomeTabsUseCase>(() => _i51.GetHomeTabsUseCase());
  gh.factory<_i52.HomeViewModel>(() => _i52.HomeViewModel(get<_i5.AppRouter>(),
      get<_i51.GetHomeTabsUseCase>(), get<_i14.Logger>()));
  gh.lazySingleton<_i53.HtmlUnescapeProvider>(
      () => _i53.HtmlUnescapeProviderImpl());
  gh.lazySingleton<_i54.Logger>(() =>
      _i55.LoggerImpl(get<_i56.CrashlyticsProvider>(), get<_i4.AppConfig>()));
  gh.lazySingleton<_i57.MoveCardUseCase>(() => _i57.MoveCardUseCase());
  gh.lazySingleton<_i58.NewsDataManager>(() => _i58.NewsDataManagerImpl(
      get<_i4.AppConfig>(),
      get<_i59.TwitterProvider>(),
      get<_i60.HtmlUnescapeProvider>()));
  gh.factory<_i61.NewsViewModel>(() => _i61.NewsViewModel(get<_i5.AppRouter>(),
      get<_i25.DataManager>(), get<_i62.DateFormatter>(), get<_i14.Logger>()));
  gh.factory<_i63.OnboardingViewModel>(() => _i63.OnboardingViewModel(
      get<_i5.AppRouter>(),
      get<_i25.DataManager>(),
      get<_i29.StringProvider>(),
      get<_i64.ConnectivityProvider>(),
      get<_i14.Logger>()));
  gh.factoryParam<_i65.PlayCardDialogViewModel, _i66.PlayCardDialogParameters?,
          dynamic>(
      (_parameters, _) => _i65.PlayCardDialogViewModel(
          _parameters,
          get<_i21.CreatePlayCardDialogActionsUseCase>(),
          get<_i5.DialogService>(),
          get<_i14.Logger>()));
  gh.factory<_i67.PrivacyPolicyViewModel>(() => _i67.PrivacyPolicyViewModel(
      get<_i9.AssetBundle>(), get<_i5.AppRouter>(), get<_i14.Logger>()));
  gh.factory<_i68.SelectDeckDialogViewModel>(() =>
      _i68.SelectDeckDialogViewModel(
          get<_i5.AppRouter>(),
          get<_i25.DataManager>(),
          get<_i5.DialogService>(),
          get<_i14.Logger>()));
  gh.lazySingleton<_i69.SettingsDataManager>(
      () => _i69.SettingsDataManagerImpl(get<_i11.SettingsStorageProvider>()));
  gh.lazySingleton<_i70.SettingsStorageProvider>(() =>
      _i70.SettingsStorageProviderImpl(get<_i46.SharedPreferencesProvider>()));
  await gh.lazySingletonAsync<_i71.SharedPreferences>(
      () => sharedPreferencesModule.provideSharedPreferences(),
      preResolve: true);
  gh.lazySingleton<_i72.SharedPreferencesProvider>(
      () => _i72.SharedPreferencesProviderImpl(get<_i71.SharedPreferences>()));
  gh.lazySingleton<_i73.SmartDuelServer>(() => _i73.SmartDuelServerImpl(
      get<_i74.WebSocketFactory>(), get<_i14.Logger>()));
  gh.lazySingleton<_i75.SnackBarService>(() => _i75.SnackBarServiceImpl());
  gh.factory<_i76.Socket>(
      () => socketIoModule.provideSocket(get<_i25.DataManager>()));
  gh.lazySingleton<_i77.SpeedDuelDialogProvider>(
      () => _i77.SpeedDuelDialogProvider());
  gh.lazySingleton<_i78.SpeedDuelEventEmitter>(() => _i78.SpeedDuelEventEmitter(
      get<_i43.SmartDuelServer>(), get<_i23.EnumHelper>(), get<_i14.Logger>()));
  gh.factoryParam<_i79.SpeedDuelViewModel, _i43.DuelRoom?, dynamic>(
      (_duelRoom, _) => _i79.SpeedDuelViewModel(
          _duelRoom,
          get<_i5.AppRouter>(),
          get<_i43.SmartDuelServer>(),
          get<_i24.CreatePlayerStateUseCase>(),
          get<_i22.CreatePlayCardUseCase>(),
          get<_i38.DoesCardFitInZoneUseCase>(),
          get<_i12.CanCardAttackZoneUseCase>(),
          get<_i57.MoveCardUseCase>(),
          get<_i78.SpeedDuelEventEmitter>(),
          get<_i13.CardEventAnimationHandler>(),
          get<_i25.DataManager>(),
          get<_i56.CrashlyticsProvider>(),
          get<_i33.SnackBarService>(),
          get<_i80.DisplayConfigService>(),
          get<_i14.Logger>()));
  gh.lazySingleton<_i81.StringProvider>(() => _i81.StringProviderImpl());
  gh.lazySingleton<_i82.SystemChromeProvider>(
      () => _i82.SystemChromeProviderImpl());
  gh.lazySingleton<_i83.TwitterApi>(
      () => twitterModule.provideTwitterApi(get<_i4.AppConfig>()));
  gh.lazySingleton<_i84.TwitterProvider>(
      () => _i84.TwitterProviderImpl(get<_i83.TwitterApi>()));
  gh.lazySingleton<_i85.UrlLauncherProvider>(
      () => _i85.UrlLauncherProviderImpl());
  gh.factory<_i86.UserSettingsViewModel>(() => _i86.UserSettingsViewModel(
      get<_i25.DataManager>(),
      get<_i33.SnackBarService>(),
      get<_i29.StringProvider>(),
      get<_i54.Logger>()));
  gh.lazySingleton<_i87.WebSocketFactory>(() => _i87.WebSocketFactoryImpl());
  gh.factory<_i88.WebSocketProvider>(
      () => _i88.WebSocketProviderImpl(get<_i76.Socket>(), get<_i14.Logger>()));
  gh.lazySingleton<_i89.YgoProDeckRestClient>(
      () => _i89.YgoProDeckRestClient(get<_i36.Dio>()));
  gh.factoryParam<_i90.YugiohCardDetailViewModel, _i25.YugiohCard?, int?>(
      (_yugiohCard, _index) => _i90.YugiohCardDetailViewModel(
          _yugiohCard, _index, get<_i14.Logger>()));
  gh.lazySingleton<_i91.YugiohCardsDataManager>(() =>
      _i91.YugiohCardsDataManagerImpl(
          get<_i92.YgoProDeckApiProvider>(),
          get<_i11.YugiohCardsStorageProvider>(),
          get<_i23.EnumHelper>(),
          get<_i14.Logger>()));
  gh.lazySingleton<_i93.YugiohCardsStorageProvider>(() =>
      _i93.YugiohCardsStorageProviderImpl(
          get<_i10.Box<_i11.DbYugiohCard>>(), get<_i14.Logger>()));
  gh.lazySingleton<_i94.CloudDatabaseProvider>(
      () => _i95.FirebaseCloudDatabaseProvider(get<_i50.FirebaseFirestore>()));
  gh.lazySingleton<_i19.CrashlyticsProvider>(
      () => _i96.FirebaseCrashlyticsProvider(get<_i49.FirebaseCrashlytics>()),
      registerFor: {_mobile});
  gh.lazySingleton<_i97.DisplayConfigService>(
      () => _i97.DisplayConfigServiceImpl(get<_i82.SystemChromeProvider>()));
  gh.lazySingleton<_i98.YgoProDeckApiProvider>(() =>
      _i98.YgoProDeckApiProviderImpl(
          get<_i89.YgoProDeckRestClient>(), get<_i14.Logger>()));
  return get;
}

class _$FlutterModule extends _i99.FlutterModule {}

class _$StorageModule extends _i100.StorageModule {}

class _$LocalizationModule extends _i101.LocalizationModule {}

class _$ConnectivityModule extends _i102.ConnectivityModule {}

class _$YgoProDeckModule extends _i103.YgoProDeckModule {}

class _$CrashlyticsModule extends _i104.CrashlyticsModule {}

class _$CloudDatabaseModule extends _i105.CloudDatabaseModule {}

class _$SharedPreferencesModule extends _i106.SharedPreferencesModule {}

class _$SocketIoModule extends _i107.SocketIoModule {}

class _$TwitterModule extends _i108.TwitterModule {}
