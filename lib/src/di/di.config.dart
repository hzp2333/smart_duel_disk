...
import '../../packages/core/core_messaging/core_messaging_interface/lib/src/snack_bar/snack_bar_service.dart'
    as _i63;
import '../../packages/core/core_navigation/lib/core_navigation.dart' as _i56;
...
import '../../packages/features/feature_duel_room/lib/src/duel_room_viewmodel.dart'
    as _i80;
import '../../packages/features/feature_home/lib/feature_home.dart' as _i58;
...
import '../navigation/router_helper.dart' as _i57;
import 'modules/core_modules.dart' as _i82;
import 'modules/third_party_modules.dart' as _i83;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i53.PlayCardDialogViewModel, _i54.PlayCard, _i55.Zone>(
      (_playCard, _newZone) => _i53.PlayCardDialogViewModel(
          _playCard,
          _newZone,
          get<_i47.CreatePlayCardDialogActionsUseCase>(),
          get<_i56.DialogService>(),
          get<_i20.Logger>()));
  gh.lazySingleton<_i56.RouterHelper>(() => _i57.RouterHelperImpl(
      get<_i25.AppConfig>(),
      get<_i11.AppRouter>(),
      get<_i56.DialogService>(),
      get<_i36.UrlLauncherProvider>(),
      get<_i58.DuelDialogProvider>(),
      get<_i59.SpeedDuelDialogProvider>()));
  gh.factory<_i60.SelectDeckDialogViewModel>(() =>
      _i60.SelectDeckDialogViewModel(get<_i56.RouterHelper>(),
          get<_i56.DialogService>(), get<_i20.Logger>()));
  gh.lazySingleton<_i61.YgoProDeckRestClient>(
      () => _i61.YgoProDeckRestClient(get<_i50.Dio>()));
  gh.factory<_i62.DeckViewModel>(() => _i62.DeckViewModel(get<_i23.Logger>(),
      get<_i56.RouterHelper>(), get<_i63.SnackBarService>()));
  gh.lazySingleton<_i41.DuelDataManager>(
      () => _i64.DuelDataManagerImpl(get<_i42.DuelStorageProvider>()));
  gh.factory<_i65.PrivacyPolicyViewModel>(() => _i65.PrivacyPolicyViewModel(
      get<_i4.AssetsProvider>(),
      get<_i3.AssetBundle>(),
      get<_i56.RouterHelper>(),
      get<_i20.Logger>()));
  gh.lazySingleton<_i66.YgoProDeckApiProvider>(
      () => _i67.YgoProDeckApiProviderImpl(get<_i61.YgoProDeckRestClient>()));
  gh.lazySingleton<_i41.YugiohCardsDataManager>(() =>
      _i68.YugiohCardsDataManagerImpl(get<_i66.YgoProDeckApiProvider>(),
          get<_i42.YugiohCardsStorageProvider>()));
  gh.lazySingleton<_i41.DataManager>(() => _i69.DataManagerImpl(
      get<_i41.NewsDataManager>(),
      get<_i41.YugiohCardsDataManager>(),
      get<_i41.DeckDataManager>(),
      get<_i41.DuelDataManager>()));
  gh.factoryParam<_i70.DeckBuilderViewModel, _i41.PreBuiltDeck, dynamic>(
      (_preBuiltDeck, _) => _i70.DeckBuilderViewModel(get<_i23.Logger>(),
          _preBuiltDeck, get<_i56.RouterHelper>(), get<_i41.DataManager>()));
  gh.factory<_i71.DuelViewModel>(() => _i71.DuelViewModel(
      get<_i23.Logger>(),
  ...
  gh.factory<_i74.OnboardingViewModel>(() => _i74.OnboardingViewModel(
      get<_i20.Logger>(), get<_i56.RouterHelper>(), get<_i41.DataManager>()));
  gh.lazySingleton<_i75.SmartDuelServer>(() => _i76.SmartDuelServerImpl(
      get<_i38.WebSocketFactory>(),
      get<_i41.DataManager>(),
      get<_i23.Logger>()));
  ...
  gh.factoryParam<_i80.DuelRoomViewModel, _i41.PreBuiltDeck, dynamic>(
      (_preBuiltDeck, _) => _i80.DuelRoomViewModel(
          get<_i20.Logger>(),
          _preBuiltDeck,
          get<_i56.RouterHelper>(),
          get<_i75.SmartDuelServer>(),
          get<_i41.DataManager>()));
  gh.factoryParam<_i81.SpeedDuelViewModel, _i75.DuelRoom, dynamic>(
      (_duelRoom, _) => _i81.SpeedDuelViewModel(
          get<_i23.Logger>(),
          _duelRoom,
          get<_i56.RouterHelper>(),
          get<_i75.SmartDuelServer>(),
          ...
          get<_i15.EnumHelper>(),
          get<_i6.CrashlyticsProvider>(),
          get<_i63.SnackBarService>()));
  return get;
}

class _$FlutterModule extends _i82.FlutterModule {}

class _$FirebaseModule extends _i83.FirebaseModule {}

class _$SharedPreferencesModule extends _i83.SharedPreferencesModule {}

class _$TwitterModule extends _i83.TwitterModule {}

class _$YgoProDeckModule extends _i82.YgoProDeckModule {}

class _$SocketIoModule extends _i83.SocketIoModule {}
